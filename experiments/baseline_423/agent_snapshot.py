# Frozen copy of src/agents/heuristic_v2_agent.py as of commit
# 82df6347a0957867630756be70f05e8cd3d06504 (exp/002-heuristic-v2), recorded as
# "baseline_423". This file is a reference snapshot only -- it is not imported
# by anything and must not be edited. If the live heuristic_v2_agent.py is
# later changed, this copy still shows exactly what baseline_423 scored.
#
# See experiments/baseline_423/manifest.yaml and reports/baseline_423_overview.md.
